...
/**
 * El código con el que el DO cierra el WebSocket cuando la grilla ya no va a
 * cambiar: la rifa se borró, se sorteó o se anuló. Va en el rango 4000–4999,
 * que el protocolo reserva para las apps.
 *
 ...
 * contra una rifa que ya no se mueve.
 */
