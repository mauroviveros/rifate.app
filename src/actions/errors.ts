 ...
 * el límite RPC de un Durable Object (ver src/utils/errors.ts). Acá se lo lee y
 ...
 * status le corresponde a cada error de dominio sigue siendo `errors.ts`, y no
 * un segundo mapa que se desincroniza.
 */
